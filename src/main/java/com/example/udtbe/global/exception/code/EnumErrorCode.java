...
public enum EnumErrorCode implements ErrorCode {
    ...
    CATEGORY_TYPE_BAD_REQUEST(HttpStatus.NOT_FOUND, "올바르지 않은 분류 타입입니다."),
    GENRE_TYPE_BAD_REQUEST(HttpStatus.NOT_FOUND, "올바르지 않은 장르 타입입니다."),
    PLATFORM_TYPE_BAD_REQUEST(HttpStatus.NOT_FOUND, "올바르지 않은 플랫폼 타입입니다."),
    ;
