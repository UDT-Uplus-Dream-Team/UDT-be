...
public abstract class ApiSupport extends TestContainerSupport {
	...
	public void setUpMembers() {
		...
		this.loginAdmin = memberRepository.save(MemberFixture.member("admin@naver.com", Role.ROLE_ADMIN));
		this.loginUser = memberRepository.save(MemberFixture.member("user@naver.com", Role.ROLE_USER));
